...
export class Assignment3 extends Scene {
    ...
    display(context, program_state) {
        ...
        this.shapes.sphere1.draw(context, program_state, model_transform, this.materials.phong);
        model_transform = model_transform.times(Mat4.translation(5, 0, 0))
        this.shapes.sphere1.draw(context, program_state, model_transform, this.materials.gouraud);
        model_transform = model_transform.times(Mat4.translation(5, 0, 0))
        this.shapes.sphere2.draw(context, program_state, model_transform, this.materials.phong);
        model_transform = model_transform.times(Mat4.translation(5, 0, 0))
        this.shapes.circle.draw(context, program_state, model_transform, this.materials.ring)
    }
}
